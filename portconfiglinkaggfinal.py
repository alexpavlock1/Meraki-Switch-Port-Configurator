        ...
        for serial in serial_list:
            for port in port_ids:
                ...
                try:
                    ...
                    print(f"\033[1m\033[3m\033[31mSuccessfully\033[0m configured port {port} on serial {serial}.")
    ...
    def configure_link_aggregation_Function(networkId, serial_list, port_ids):
        for serial in serial_list:
            ...
            try:
                ...
                print(f"\033[1m\033[3m\033[31mSuccessfully\033[0m configured link aggregation for the following configuration: {payload}. Response: {response}")
            except Exception as e:
                print(f"\033[1m\033[3m\033Error\033[0m configuring link aggregation with the following configuration: {payload}. Error: {e}")
