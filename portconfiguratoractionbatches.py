...
def configure_ports_choice():
    ...
    def get_org_id():
        while True:
            try:
                ...
                if not response:
                    print("No organizations found with the provided API key. Please ensure your API key is correct and try again.")
                    return None
                ...
                if org_id in valid_org_ids:
                    ...
                    print("The entry did not match any of the organization IDs tied to that API key. Please try again.")

            except meraki.APIError as e:
                if 400 <= e.status <= 499:
                    print(f"Client error occurred: {e.status} {e.reason}")
                    if e.status == 401:
                        print("Invalid API key. Please ensure your API key is correct and try again.")
                    return None
                else:
    ...
    if network_names is None:
        print("An error occurred while retrieving the network names.")
    else:
        ...
        while True:
            ...
            if networkselection in valid_network_ids:
                ...
                print("The network number you entered is not valid for the selected organization. Please try again.")
    ...
    def tag_selection_function(seen_tags):
        while True:
            ...
            if tagselection in seen_tags:
                ...
                print(f"Invalid input. You entered a tag name that is not assigned to any switches in the network you selected. Please enter one of the tag names: {', '.join(sorted(seen_tags))}")
    ...
    def poe_enabled_Function(profile_Enabled):
        ...
        while True: 
            ...
            if poe_enabled in valid_inputs:
                ...
                print("Invalid input. Please enter 'true', 'false', or leave blank to skip.")
    def port_type_Function(profile_Enabled):
        ...
        while True:
            ...
            if port_type in valid_inputs:
                ...
                print("Invalid input. Please enter 'access' or 'trunk'.")
    def vlan_Function(profile_Enabled, port_type):
        ...
        while True:  # Keep asking until a valid input is provided
            ...
            print("Invalid input. Please enter a VLAN number or range between 1-4094 or leave blank.")
    def voice_Vlan_Function(profile_Enabled, port_type):
        ...
        while True:  # Keep asking until a valid input is provided
            ...
            if is_valid_vlan(voice_vlan):
                ...
                print("Invalid input. Please enter a valid VLAN number between 1-4094 or leave blank.")
    def allowed_Vlans_Function(profile_Enabled, port_type):
        ...
        while True:  # Keep asking until a valid input is provided
            ...
            # If the input is not valid, print an error message and ask again
            print("Invalid input. Please enter valid VLAN numbers or ranges between 1-4094, or leave blank to skip.")
    def access_policy_Function(profile_Enabled, port_type):
        ...
        while True:
            ...
            if access_policy == "" or access_policy in valid_inputs:
                ...
                print("Invalid input. Please enter one of the allowed policies exactly as shown including punctuation, or leave blank to skip.")
        ...
        if access_policy == "Sticky MAC allow list":
            while True:  # Keep asking until a valid input is provided
                ...
                if sticky_Mac_Allow_List_Limit.isdigit() and 1 <= int(sticky_Mac_Allow_List_Limit) <= 20:
                    ...
                    print("Invalid input. Dashboard only allows for a number between 1 and 20. Please enter a number between 1 and 20.")
        else:
        ...
        if access_policy == "Custom access policy":
            while True:  # Keep asking until a valid input is provided
                ...
                if access_Policy_Number.isdigit() and 1 <= int(access_Policy_Number) <= 8:
                    ...
                    print("Invalid input. Dashboard allows for a maximum of 8 access policies. Please enter the policy number, the number must be between 1 and 8.")
    ...
    def stp_Guard_Function(profile_Enabled):
        ...
        while True:
            ...
            if stp_Guard in valid_inputs:
                ...
                print("Invalid input. Please enter 'disabled, 'root guard', 'bpdu guard', 'loop guard', or leave blank to skip.")
    def link_negotiation_Function(profile_Enabled):
        ...
        while True:
            ...
            if link_negotiation in valid_inputs:
                ...
                print("Invalid input. Make sure your entry matches exactly to one of the options given (including punctuation) or leave blank to skip.")
    ...
    def udld_Function(profile_Enabled):
        ...
        while True:
            ...
            if udld in valid_inputs:
                ...
                print("Invalid input. Please enter either 'Alert only', 'Enforce', or leave blank to skip.")
