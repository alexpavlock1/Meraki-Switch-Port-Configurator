        ...
        for entry in entries:
            ...
            if '-' in entry:
                try:
                    ...
                    print(f"\033[1m\033[3m\033[31mInvalid range '{entry}'. Please enter a valid range like '1-24'.\033[0m\n")
                continue
            ...
            try:
                ...
                print(f"\033[1m\033[3m\033[31mInvalid port number '{entry}'. Please enter a valid number.\033[0m\n")
        ...
        for entry in entries:
            ...
            if '-' in entry:
                try:
                    ...
                    print(f"\033[1m\033[3m\033[31mInvalid range\033[0m '{entry}'. \033[1m\033[3m\033[31mPlease enter a valid range like '1-24'.\033[0m")
                continue
